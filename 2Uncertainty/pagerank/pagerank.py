...
def PR(corpus, d, currentValues):
    ...
    for page in corpus:
        ...
        # checking every other page to see if it links to page
        for potential_link in corpus:
            links = corpus[potential_link]

            if not links:
                total += currentValues[potential_link] / len(corpus)
            elif page in links:
                total += currentValues[potential_link] / len(links)
